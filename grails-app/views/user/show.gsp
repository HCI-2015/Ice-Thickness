	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.recentActivities}">
				<li class="fieldcontain">
					<span id="recentActivities-label" class="property-label"><g:message code="user.recentActivities.label" default="Recent Activities" /></span>
					
						<span class="property-value" aria-labelledby="recentActivities-label"><g:fieldValue bean="${userInstance}" field="recentActivities"/></span>
