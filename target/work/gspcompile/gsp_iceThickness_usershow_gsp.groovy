...
class gsp_iceThickness_usershow_gsp extends GroovyPage {
...
printHtmlPart(17)
if(true && (userInstance?.recentActivities)) {
printHtmlPart(20)
invokeTag('message','g',46,['code':("user.recentActivities.label"),'default':("Recent Activities")],-1)
printHtmlPart(21)
invokeTag('fieldValue','g',48,['bean':(userInstance),'field':("recentActivities")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
if(true && (userInstance?.profilePicture)) {
printHtmlPart(22)
invokeTag('message','g',55,['code':("user.profilePicture.label"),'default':("Profile Picture")],-1)
printHtmlPart(23)
invokeTag('fieldValue','g',57,['bean':(userInstance),'field':("profilePicture")],-1)
printHtmlPart(16)
}
printHtmlPart(24)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1427296728000L
